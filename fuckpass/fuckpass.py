...
if len(sys.argv) < 2 or sys.argv[1] == '-h':
	print " ___________ "
	print " \033[07m  Fuck Nath! \033[27m               # BaBu"
	print "      \                     # Usuario"
	print "       \   \033[1;31m,__,\033[1;m             # Senhas"
	print "        \  \033[1;31m(\033[1;moo\033[1;31m)____\033[1;m         # Perfis"
	print "           \033[1;31m(__)    )\ \033[1;m  "
	print "           \033[1;31m   ||--|| \033[1;m\033[05m*\033[25m\033[1;m      [ Lusgaz | lucasferraz@protonmail.com ]\r\n\r\n"

	print "	[ Opcoes ]\r\n"
	print "	-h	Voce esta olhando para ele, baby! :)"
	print " 		 Para mais ajuda, explore docs/README"
	print "		 O arquivo de configuracao global e cupp.cfg\n"

	print "	-i	Perguntas interativas para o perfil de senha do usuario\r\n"

	print "	-w	Use esta opcao para melhorar o dicionario existente,"
	print "		 ou a saida do WyD.pl para fazer alguns pwnsauce\r\n"

	print "	-l	Baixe wordlists enormes do repositorio\r\n"
	...
	print "		 que foi fundido e aprimorado.\r\n"
	print "	-v	Versao do programa\r\n"
	exit()

elif sys.argv[1] == '-v':
	print "\r\n	\033[1;31m[ cupp.py ]  v1.0.0-alpha\033[1;m\r\n"
	print "	* Coded by j0rgan and Lusgaz - j0rgan@remote-exploit.org"
	print "	* http://www.porn-hub.com\r\n"
	...
	print "      *         Usar wordlists extensas na         *"
	print "      *       opcoes abaixo NAO e recomendavel!      *"
	print "      *************************************************\r\n"

	conts = raw_input("> Deseja concatenar todas as palavras da wordlist? Y/[N]: ").lower()



	if conts == "y" and linije > threshold:
		print "\r\n[-] O numero maximo de palavras para concatenacao e "+str(threshold)
		print "[-] Verifique o arquivo de configuracao para aumentar esse numero.\r\n"
		conts = raw_input("> Deseja concatenar todas as palavras da wordlist? Y/[N]: ").lower()
	conts = conts
	cont = ['']
	if conts == "y":
	...
	spechars = ['']
	spechars1 = raw_input("> Deseja adicionar caracteres especiais ao final das palavras? Y/[N]: ").lower()
	if spechars1 == "y":
		for spec1 in chars:
	...
	randnum = raw_input("> Deseja adicionar numeros ao final das palavras? Y/[N]:").lower()
	leetmode = raw_input("> Modo Leet? (ou seja, leet = 1337) Y/[N]: ").lower()
	...
	print "[+] Lista de classificacao e remocao de duplicatas..."
	...
	print "\r\n[+] Insira as informacoees sobre a vitima para criar o dicionario!"
	print "[+] As informacoes que voce nao souber, pressione enter para pular! ;)\r\n"

# Precisa colocar as informacoes primeiro!

	name = raw_input("> Nome: ").lower()
	while len(name) == 0 or name == " " or name == "  " or name == "   ":
		print "\r\n[-] Insira o sobrenome "
		name = raw_input("> Sobrenome: ").lower()
	name = str(name)

	surname = raw_input("> Sobrenome: ").lower()
	nick = raw_input("> Apelido: ").lower()
	birthdate = raw_input("> Aniversario (DDMMYYYY): ")
	while len(birthdate) != 0 and len(birthdate) != 8:
		print "\r\n[-] Deve conter 8 digitos para o aniversario!"
		birthdate = raw_input("> Data de aniversario! (DDMMYYYY): ")
	birthdate = str(birthdate)

	print "\r\n"

	wife = raw_input("> Nome) esposa: ").lower()
	wifen = raw_input("> Apelido): ").lower()
	wifeb = raw_input("> Aniversario) da pessoa ou comemoracao do casal  (DDMMYYYY): ")
	while len(wifeb) != 0 and len(wifeb) != 8:
		print "\r\n[-] Deve conter 8 digitos para o aniversario!"
		wifeb = raw_input("> Aniversario de (DDMMYYYY): ")
	wifeb = str(wifeb)
	print "\r\n"

	kid = raw_input("> Nome do filho(a): ").lower()
	kidn = raw_input("> Apelido do: ").lower()
	kidb = raw_input("> Aniversario do filho (DDMMYYYY): ")
	...
	pet = raw_input("> Nome do animalzinho : ").lower()
	company = raw_input("> Nome do local que trabalha: ").lower()
	print "\r\n"

	words = ['']
	words1 = raw_input("> Deseja adicionar algumas palavras-chave sobre a vitima? Y/[N]: ").lower()
	words2 = ""
	if words1 == "y":
		words2 = raw_input("> Digite as palavras, separadas por virgulas. [i.e. hacker, suco, preto], os espacos serao removidos: ").replace(" ","")
	words = words2.split(",")
	...
	randnum = raw_input("> Voce deseja adicionar alguns numeros aleatorios no final das palavras? Y/[N]:").lower()
...
# Birthdays first
	...
	# Combinacao da data dos aniversarios
	...
	print "[+] Revendo a lista da sorte e removendo as senhas duplicadas..."
	...
	print "\r\n[+] Verificando se alectodb nao esta presente..."
	if os.path.isfile('alectodb.csv.gz') == 0:
		print "[+] baixando alectodb.csv.gz..."
	...
	print "	\r\n	Escolha a secao no qual deseja fazer download:\r\n"
	...
	print "	\r\n	Os arquivos serao baixados de "+ftpname+" "
	print "	\r\n	Tip: Depois de baixar a wordlist desejada, voce pode melhorar com a opcao -w\r\n"

	filedown = raw_input("> Coloque o numero: ")
	filedown.isdigit()
	...
	if filedown == "8":
		...
		print "\r\n[+] baixando czech-wordlist-ascii-cstug-novak.gz..."
